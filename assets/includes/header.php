                    ...
                    <ul class="header-menu nav navbar-nav" id="desktopview">
                        ...
                        <li class="dropdown" id="user-header">
                            <a href="#" data-toggle="dropdown" data-hover="dropdown" data-close-others="true">
                                ...
                                <span class="username" style="color:white;">Dr&nbsp; <?=$this->session->userdata('drusername');?>
                                <?=$this->session->userdata('druserlname');?><i class="fa fa-chevron-down" aria-hidden="true"></i></span>
                            </a>
