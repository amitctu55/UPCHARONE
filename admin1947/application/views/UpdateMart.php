				...
				<div class="box box-primary" >
					<?php if($this->session->userdata('response')!=''){ echo $this->session->userdata('response');}?>
						...
						<div style="width:28%;float:left;">
							<!-- form start -->
							<form name="form" method="post" action="<?=base_url();?>setting/AddMartLang/<?=$encrypted_string;?>" enctype="multipart/form-data">	
							...
							<div class="form-group">
								<label>Market</label>
								<input type="text"  class="form-control" id="mart" name="mart" value="<?php echo set_value("mart")?>">
								<?=$city?>
							</div>
							...
							<table id="example1" class="table table-bordered table-striped">
									...
									?>
                                      ...
                                      <tr id="link<?=$rec2['id']?>">
                                          <td><?=$rec2['name'];?></td>
                                          <td><?=$LangName;?></td>
                                          <td><a href="<?=base_url()?>setting/UpdateMartLang/<?=$Citykey?>" target="_blank">Update</a> | <a onclick=DelMartLang("<?=$Citykey?>")>Delete</a></td>
                                      </tr>
