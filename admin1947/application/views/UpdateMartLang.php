               ...
               <section class="content">
				...
				<div class="box box-primary" >
					<?php if($this->session->userdata('response')!=''){ echo $this->session->userdata('response');}?>
						...
						<!-- form start -->
						<form name="form" method="post" action="<?=base_url();?>setting/MartLangUpdate/<?=$cityLangKey;?>" enctype="multipart/form-data">
						...
						<div class="form-group">
								...
								<input type="text"  class="form-control" id="pincode" name="pincode" value="<?=$pin;?>" required="true">
								<?=$city?>
							</div>
