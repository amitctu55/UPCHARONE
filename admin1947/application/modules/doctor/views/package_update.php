								...
								<h4 class="mainhead"><?php ?></h4>
		  						<form class="form-horizontal formbody" id='mainform' action=""  method="post" enctype="multipart/form-data">
									...
									<div class="row">
										...
										<div class="col-md-12">
											<div class="form-group">
											  <label class="control-label col-sm-2 label-name" for="email"> Amount<span class="starspan">*</span></label>
											  <div class="col-sm-7">
												<input type="number" class="form-control input-sm" id="amount" name="amount" data-validation="required"
												data-validation-error-msg="This Field is required" value="<?=$row['amount'];?>">
											  </div>
											</div>
										</div>
										<div class="col-md-12">
											...
											<div class="form-group" id="image">
												...
												<div class="col-sm-7">
													...
													<div class="container">
														...
														if($row['image'] !='') { ?>
							  							<a data-toggle="modal" data-target="#myModal<?php echo $row['package_id'];?>">View Image</a>
													  	<!-- The Modal -->
													  	<div class="modal" id="myModal<?php echo $row['package_id'];?>">
