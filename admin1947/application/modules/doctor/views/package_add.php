  			...
  			<div class="content-wrapper">
				...
				<section class="content-header">
					...
					<ol class="breadcrumb">
						...
						<li><a href="<?php echo base_url();?>users/package"> Back To List</a></li>
  						...
  						<div class="row text-">
							<div class="container">
								<?=$this->session->flashdata('flashmsg');?>
	  							<form class="form-horizontal formbody" id='mainform' action="<?=base_url()?>users/package/create" method="post" enctype="multipart/form-data">
									<!--Basic Details-->
