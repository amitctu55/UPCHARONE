			...
			<div class="col-md-4">
				<div class="form-group">
				  	...
				  	<div class="col-sm-7">
						...
						<div class="container">
							<?php	$product_path = "public/assets/upload/".$clinic->drimage;
							if($clinic->drimage !='') { ?>
  							<a data-toggle="modal" data-target="#myModal<?php echo $clinic->id;?>">View Image</a>
						  	<!-- The Modal -->
						  	<div class="modal" id="myModal<?php echo $clinic->id;?>">
			...
			<div class="col-md-4">
				<div class="form-group">
				  	...
				  	<div class="col-sm-7">
						...
						<div class="container">
							<?php	$product_path = "public/assets/upload/".$clinic->id_proof;
							if($clinic->id_proof !='') { ?>
  							<a data-toggle="modal" data-target="#myModal1<?php echo $clinic->id;?>">View Image</a>
						  	<!-- The Modal -->
						  	<div class="modal" id="myModal1<?php echo $clinic->id;?>">
						    	<div class="modal-dialog">
						      		<div class="modal-content">
						        		<!-- Modal Header -->
						        		<div class="modal-header">
			...
			<div class="col-md-4">
				<div class="form-group">
				  	...
				  	<div class="col-sm-7">
						...
						data-validation-error-msg="This Field is required">
						<div class="container">
							<?php	$product_path = "public/assets/upload/".$clinic->med_reg_proof;
							if($clinic->med_reg_proof !='') { ?>
  							<a data-toggle="modal" data-target="#myModal1<?php echo $clinic->id;?>">View Image</a>
						  	<!-- The Modal -->
						  	<div class="modal" id="myModal1<?php echo $clinic->id;?>">
						    	<div class="modal-dialog">
