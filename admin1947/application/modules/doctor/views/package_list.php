			...
			<div class="content-wrapper">
				...
				<section class="content">
					<div class="container bg-3 ">
						<?php echo form_open("doctor/package/",'class="form-horizontal formbody" id="search_form" method="get"');  ?>
						<div class="row mainheadlinefirstrow">
							<div class="col-md-12 mainheadlinefirst">Basic Filter
								<!--<a  href="<?php //echo base_url();?>doctor/package/add" class="btn btn-info" style="float:right;" id="submit" >Add Package</a>-->
							</div>
						</div>
						<div class="row">
							<div class="col-md-12">
								<div class="form-group">
									...
									<div class="col-sm-3">
										...
										{ 
											echo anchor("doctor/package/",'<span>Clear Search</span>');    
										} 
										?>
									</div>
								</div>
						...
						echo form_open_multipart("doctor/package/", $att);?>
							...
							<table class="table table-hover table-bordered table-bordered" id='example' style="border:none;">
								<thead>
									<tr>
										...
										<th class="tableheaddata">Image</th>
								...
								<tbody id="tviewtablebody">
									...
									<tr>
										...
										<td>
											<?php
											if($val['description']!=''){ ?>
											<a data-toggle="modal" style="color:red;" data-target="#myModal<?php echo $val['package_id'];?>">View</a>
											<!-- The Modal -->
											<div class="modal" id="myModal<?php echo $val['package_id'];?>">
												<div class="modal-dialog">
													<div class="modal-content">
														<!-- Modal Header -->
														<div class="modal-header">
															<button type="button" class="close" data-dismiss="modal">×</button>
															<h4 style="color:#535456;" class="modal-title">Description</h4>
														</div>
														<!-- Modal body -->
														<div class="modal-body">
															<p style="color:#535456;"><?php echo $val['description'];?></p>
														</div>
													</div>
												</div>
											</div>
										...
										<td>
											<?php $product_path = "public/assets/upload/".$val['image'];
											if($val['image']!=''){ ?>
										...
										<td><a href="<?php echo base_url();?>doctor/package/update/<?php echo $val['package_id']; ?>" style="color:red;">Edit</a></td>
									</tr>
									<?php 
									} 
									}?>
