  						...
  						<div class="row text-">
							<div class="container">
								<?=$this->session->flashdata('flashmsg');?>
	  							<form class="form-horizontal formbody" id='mainform' action="<?=base_url()?>doctor/pathtest/edit/<?php echo $res['test_id']; ?>" method="post" enctype="multipart/form-data">
									<!--Basic Details-->
												...
												<label class="control-label col-sm-2 label-name" for="email"> Path Lab <span class="starspan">*</span></label>
											  	<div class="col-sm-4">
													<select name="path_id" id="path_id" class="form-control input-sm" data-validation="required" data-validation-error-msg="This Field is required">
														...
														<option value="<?php echo $val['id'];?>" <?php if($val['id']==set_value('path_id',$res['path_id'])){ echo "selected"; } ?>><?php echo $val['name'];?></option>
														<?php }} ?>
													</select>
										...
										<div class="col-md-12">
											<div class="form-group">
												<label class="control-label col-sm-2 label-name" for="email"> Test Name <span class="starspan">*</span></label>
											  	<div class="col-sm-4">
													<input type="text" class="form-control input-sm" id="test_name" name="test_name" data-validation="required" data-validation-error-msg="This Field is required" value="<?php echo set_value('test_name',$res['test_name'])?>">
												...
												<label class="control-label col-sm-2 label-name" for="email"> Short Name  <span class="starspan">*</span></label>
											  	<div class="col-sm-4">
													<input type="text" class="form-control input-sm" id="short_name" name="short_name" data-validation="required" data-validation-error-msg="This Field is required" value="<?php echo set_value('short_name',$res['short_name'])?>">
											...
											<div class="form-group">
												<label class="control-label col-sm-2 label-name" for="email"> Test Type   <span class="starspan">*</span></label>
											  	<div class="col-sm-4">
													<input type="text" class="form-control input-sm" id="test_type" name="test_type" data-validation="required" data-validation-error-msg="This Field is required" value="<?php echo set_value('test_type',$res['test_type'])?>">
												...
												<label class="control-label col-sm-2 label-name" for="email"> Category <span class="starspan">*</span></label>
											  	<div class="col-sm-4">
													<select name="category_id" id="category_id" class="form-control input-sm" data-validation="required" data-validation-error-msg="This Field is required">
														...
														<option value="<?php echo $val['category_id'];?>" <?php if($val['category_id']==set_value('category_id',$res['category_id'])){ echo "selected"; } ?>><?php echo $val['category_name'];?></option>
														<?php }} ?>
													</select>
											...
											<div class="form-group">
												<label class="control-label col-sm-2 label-name" for="email"> Sub Category <span class="starspan"></span></label>
											  	<div class="col-sm-4">
													<input type="text" class="form-control input-sm" id="sub_category" name="amount" data-validation="" data-validation-error-msg="This Field is required" value="<?php echo set_value('sub_category',$res['sub_category'])?>">
												...
												<label class="control-label col-sm-2 label-name" for="email"> Method <span class="starspan"></span></label>
											  	<div class="col-sm-4">
													<input type="text" class="form-control input-sm" id="method" name="method" data-validation="" data-validation-error-msg="This Field is required" value="<?php echo set_value('method',$res['method'])?>">
											...
											<div class="form-group">
												<label class="control-label col-sm-2 label-name" for="email"> Report Days <span class="starspan"></span></label>
											  	<div class="col-sm-4">
													<input type="text" class="form-control input-sm" id="report_day" name="report_day" data-validation="" data-validation-error-msg="This Field is required" value="<?php echo set_value('report_day',$res['report_day'])?>">
												...
												<label class="control-label col-sm-2 label-name" for="email"> Charge Category<span class="starspan">*</span></label>
											  	<div class="col-sm-4">
													<input type="text" class="form-control input-sm" id="charge_category" name="charge_category" data-validation="required" data-validation-error-msg="This Field is required" value="<?php echo set_value('charge_category',$res['charge_category'])?>">
											...
											<div class="form-group">
												<label class="control-label col-sm-2 label-name" for="email"> Code <span class="starspan">*</span></label>
											  	<div class="col-sm-4">
													<input type="text" class="form-control input-sm" id="code" name="code" data-validation="required" data-validation-error-msg="This Field is required" value="<?php echo set_value('code',$res['code'])?>">
												...
												<label class="control-label col-sm-2 label-name" for="email"> Standard Charge<span class="starspan">*</span></label>
											  	<div class="col-sm-4">
													<input type="text" class="form-control input-sm" id="amount" name="amount" data-validation="required" data-validation-error-msg="This Field is required" value="<?php echo set_value('amount',$res['amount'])?>">
									...
									<div class="row">
										<div class="col-md-8">
											<div class="form-group">
											  	<div class="radio"><label><input type="radio" name="status" value='1' <?php if(set_value('status',$res['status'])=='1'){?> checked="" <?php } ?> >Active</label></div>
											  	<div class="radio"><label><input type="radio" name="status" value='0' <?php if(set_value('status',$res['status'])=='0'){?> checked="" <?php } ?>>Inactive</label></div>
											</div>
										</div>
									</div>
									<div class="row">
										<div class="col-md-8">
											<div class="form-group">
											  	<div class="radio"><label><input type="radio" name="approved" value='1' <?php if(set_value('approved',$res['approved'])=='1'){?> checked="" <?php } ?> >Approved</label></div>
											  	<div class="radio"><label><input type="radio" name="approved" value='0'  <?php if(set_value('approved',$res['approved'])=='0'){?> checked="" <?php } ?> >Not Approved</label></div>
											</div>
										</div>
									</div>
									<div class="row">
