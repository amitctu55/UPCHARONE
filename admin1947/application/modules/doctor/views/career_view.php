		...
		<div class="content-wrapper">
			...
			<section class="content">
				...
				<div class="container bg-3 "> 
					<?php echo form_open("doctor/career/",'class="form-horizontal formbody" id="search_form" method="get"');  ?>
						...
						<div class="col-md-12">
							<div class="form-group">
								...
								<div class="col-sm-3">
									...
									{ 
										echo anchor("doctor/career/",'<span>Clear Search</span>');    
									} 
									?>
								</div>
							</div>
					...
					echo form_open_multipart("doctor/career/", $att);?>
						...
						<table class="table table-hover table-bordered table-bordered" id='neodatatable' style="border:none;">
							<thead>
								<tr>
									...
									<th class="tableheaddata">Designation</th>
									<th class="tableheaddata">Qualification</th>
									<th class="tableheaddata">Message</th>
									<th class="tableheaddata">Resume</th>
							...
							<tbody>
								<tr>
									<td><input style="width:15px;" type="checkbox" name="arr_ids[]" value="<?php echo $val['career_id'];?>" id="check-all" class="flat"></td>
									...
									<td class="tableheaddata"><?php echo $val['designation']?></td>
									<td class="tableheaddata"><?php echo $val['qualification']?></td>
									<td class="tableheaddata"><?php echo $val['message']?></td>
									<td>
										<?php
										if($val['resume']!=''){ ?>
										<a data-toggle="modal" style="color:red;" data-target="#myModal<?php echo $val['career_id'];?>">View</a>
										<!-- The Modal -->
										<div class="modal" id="myModal<?php echo $val['career_id'];?>">
											<div class="modal-dialog">
												<div class="modal-content">
													<!-- Modal Header -->
													<div class="modal-header">
														<button type="button" class="close" data-dismiss="modal">×</button>
														<h4 style="color:#535456;" class="modal-title">Resume</h4>
													</div>
													<!-- Modal body -->
													<div class="modal-body">
														<embed src="<?php echo base_url();?>public/assets/document/<?php echo $val['resume'];?>" type="application/pdf"   height="700px" width="100%">
													</div>
												</div>
											</div>
										</div>
					...
					<div class="row">
							<div class="col-md-7">
								<input name="status_action" style="width: 150px; font-weight: bold;" type="submit" value="Activate" class="button2 btn-sm btn btn-success" id="Active" onClick="return validcheckstatus('arr_ids[]','Record','Record','u_status_arr[]');"/>
