  ...
  <div class="row text-">
	...
	<h4 class="mainhead">Doctor Registration</h4>
	  ...
	  <form class="form-horizontal formbody" id='mainform' action="" method="post" enctype="multipart/form-data">
		...
		<div class="col-md-4">
				<div class="form-group">
				  ...
				  <div class="col-sm-7">
					...
					data-validation-error-msg="This Field is required" value="<?=$profile_dr->fname.' '.$profile_dr->lname; ?>" readonly>
				  </div>
				</div>
			</div>
			...
			<div class="col-md-4">
				<div class="form-group">
				  ...
				  <div class="col-sm-7">
					<input type="text" class="form-control input-sm" id="t_lname" name="t_lname" value="<?=$this->session->userdata('lname');?>" readonly>
				  </div>
				</div>
			</div>
		...
		<div class="col-md-4">
			...
			<div class="col-md-4">
				<div class="form-group">
				  ...
				  <div class="col-sm-7">
					<input type="email" class="form-control input-sm" id="email" name="email" value="<?=$profile_dr->email ;?>" readonly>
				  </div>
				</div>
			</div>
			<div class="col-md-4">
				<div class="form-group">
				  ...
				  <div class="col-sm-7">
					<input type="text" class="form-control input-sm" id="mobile" name="mobile" data-validation="required,number" data-validation-allowing="range[6000000000;9999999999]" data-validation-error-msg="Enter 10 digit valid no." onkeypress="return isNumber(event)" value="<?=$profile_dr->mobile ;?>" readonly>
				  </div>
				</div>
			</div>
		...
		<div class="row">
			...
			<div class="col-md-4">
				<div class="form-group">
				  ...
				  <div class="col-sm-7">
				  <input type="text" class="form-control input-sm" id="regno" name="regno" value="<?=$profile_dr->regd_no;?>" readonly>
			...
			<div class="col-md-4">
				<div class="form-group">
				  ...
				  <div class="col-sm-7">
					<input type="text" class="form-control input-sm" id="year" onkeypress="return isNumber(event)" name="year" value="<?=$profile_dr->year;?>" readonly>
				  </div>
				</div>
			</div>
			...
			<div class="col-md-4">
				<div class="form-group">
				  ...
				  <div class="col-sm-7">
					<input type="text" class="form-control input-sm" onkeypress="return isNumber(event)" id="exprience" name="exprience" value="<?=$profile_dr->exp;?>" readonly>
				  </div>
				</div>
			</div>
			...
			<div class="col-md-4">
				<div class="form-group">
				  ...
				  <div class="col-sm-7">
					<input type="text" class="form-control input-sm" id="achievement" name="achievement" value="<?=$profile_dr->achievement ;?>" readonly>
				  </div>
				</div>
			</div>
        ...
        <img src="<?=base_url();?>public/assets/upload/<?=($profile_dr->drimage)? $profile_dr->drimage : 'dummydr.jpg';?>"  style="border-radius: 50%; margin-left: 113px; width: 150px; height: 150px;"> 
				...
				<div class="rounded-circle">
				          <img src="<?=base_url();?>public/assets/upload/<?=($profile_dr->id_proof)? $profile_dr->id_proof : 'dummydr.jpg';?>"  style="border-radius: 50%;margin-left: 50px; width: 150px; height: 150px;">				 
				          </div>
				</div>
				...
				<div class="col-md-4">
				<div class="form-group">
				          <img src="<?=base_url();?>public/assets/upload/<?=($profile_dr->med_reg_proof)? $profile_dr->med_reg_proof : 'dummydr.jpg';?>"  style="border-radius: 50%; width: 150px; height: 150px;">
				  				  </div>
				</div>
			...
			<div class="col-md-12">
				<div class="form-group">
				  ...
				  <div class="col-sm-8">
					...
					data-validation-error-msg="This Field is required" ><?=$profile_dr->short_about;?></textarea>
				  </div>
				</div>
			</div>
			...
			<div class="col-md-4">
				<div class="form-group">
				  ...
				  <div class="col-sm-7" id="cadd">
					<input type="text" class="form-control input-sm" id="fee" name="fee[]" value="<?=$profile_dr->fee;?>" readonly>
				  </div>
				</div>
			</div>
			<br>
					...
					<div class="col-md-4">
						<div class="form-group">
						  ...
						  <div class="col-sm-7" id="ccont">
							<input type="text" class="form-control input-sm timepicker" id="fromtime[0][0][]" name="fromtime[0][0][]"  value="<?=formateDate($profile_dr->creat_date)?>" readonly>
						  </div>
						</div>
					</div>
					<div class="col-md-4">
						<div class="form-group">
						  ...
						  <div class="col-sm-7" id="cema">
							<input type="text" class="form-control input-sm timepicker" id="totime[0][0][]" name="totime[0][0][]" value="<?=formateDate($profile_dr->creat_date)?>" readonly>
						  </div>
						</div>
					</div>
				</div>
