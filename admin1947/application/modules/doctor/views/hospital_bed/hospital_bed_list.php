			...
			<div class="content-wrapper">
				...
				<section class="content">
					<div class="container bg-3 ">
						<?php echo form_open("doctor/hospital_bed/",'class="form-horizontal formbody" id="search_form" method="get"');  ?>
						<div class="row mainheadlinefirstrow">
							<div class="col-md-12 mainheadlinefirst">Basic Filter
								<a  href="<?php echo base_url();?>doctor/hospital_bed/add" class="btn btn-info" style="float:right;" id="submit" >Add Hospitala Bed</a>
							</div>
						</div>
						<div class="row">
							<div class="col-md-12">
								<div class="form-group">
									...
									<div class="col-sm-3">
										...
										{ 
											echo anchor("doctor/hospital_bed/",'<span>Clear Search</span>');    
										} 
										?>
									</div>
								</div>
						...
						echo form_open_multipart("doctor/hospital_bed/", $att);?>
							...
							<table class="table table-hover table-bordered table-bordered" id='example' style="border:none;">
								<thead>
									<tr>
										...
										<th class="tableheaddata">Bed Type</th>
										<th class="tableheaddata">Total Bed</th>
										<th class="tableheaddata">Occupied Bed</th>
										<th class="tableheaddata">Comment</th>
								...
								<tbody id="tviewtablebody">
									...
									<tr>
										...
										<td><?php echo $val['bed_type']?></td>
										<td><?php echo $val['total_bed']?></td>
										<td><?php echo $val['occupied_bed']?></td>
										<td>
											<?php
											if($val['comment']!=''){ ?>
											<a data-toggle="modal" style="color:red;" data-target="#myModal<?php echo $val['hospital_bed_id'];?>">View</a>
											<!-- The Modal -->
											<div class="modal" id="myModal<?php echo $val['hospital_bed_id'];?>">
												<div class="modal-dialog">
													<div class="modal-content">
														<!-- Modal Header -->
														<div class="modal-header">
															<button type="button" class="close" data-dismiss="modal">×</button>
															<h4 style="color:#535456;" class="modal-title">Comment</h4>
														</div>
														<!-- Modal body -->
														<div class="modal-body">
															<p style="color:#535456;"><?php echo $val['comment'];?></p>
														</div>
													</div>
												</div>
											</div>
										...
										<td><a href="<?php echo base_url();?>doctor/hospital_bed/update/<?php echo $val['hospital_bed_id']; ?>" style="color:red;">Edit</a></td>
									</tr>
									<?php 
									} 
									}?>
