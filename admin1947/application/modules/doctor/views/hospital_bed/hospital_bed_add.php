  			...
  			<div class="content-wrapper">
				...
				<section class="content-header">
					...
					<ol class="breadcrumb">
						...
						<li><a href="<?php echo base_url();?>doctor/hospital_bed"> Back To List</a></li>
  						...
  						<div class="row text-">
							<div class="container">
								<?=$this->session->flashdata('flashmsg');?>
	  							<form class="form-horizontal formbody" id='mainform' action="<?=base_url()?>doctor/hospital_bed/add" method="post" enctype="multipart/form-data">
									<!--Basic Details-->
									...
									<div class="row">
											...
											<div class="form-group">
											  	...
											  	<div class="col-sm-7">
													<select name="hospital_id" class="form-control input-sm" data-validation="required">
														...
														<option value="<?php echo $val['id'];?>" <?php if($val['id']==set_value('hospital_id')){ echo "selected";}?>> <?php echo $val['name'];?></option>	
														<?php }} ?>
													</select>
										...
										<div class="col-md-12">
											<div class="form-group">
											  	...
											  	<div class="col-sm-7">
													<input type="text" class="form-control input-sm" id="bed_type" name="bed_type" data-validation="required" data-validation-error-msg="This Field is required" value="<?php echo set_value('bed_type');?>">
										...
										<div class="col-md-12">
											<div class="form-group" >
												...
												<div class="col-sm-7">
													<input type="text" name="total_bed" id="total_bed"   class="form-control input-sm" value="<?php echo set_value('total_bed');?>" maxlength="60" data-validation="required" data-validation-error-msg="This Field is required" />
										...
										<div class="col-md-12">
											<div class="form-group" >
												...
												<div class="col-sm-7">
													<input type="text" name="occupied_bed" id="occupied_bed"   class="form-control input-sm" value="<?php echo set_value('occupied_bed');?>" maxlength="60" data-validation="required" data-validation-error-msg="This Field is required" />
										...
										<div class="col-md-12">
											<div class="form-group">
											  	...
											  	<div class="col-sm-7">
													<textarea class="form-control input-sm" id="comment" name="comment" data-validation="required" data-validation-error-msg="This Field is required" ><?php echo set_value('comment');?></textarea>
