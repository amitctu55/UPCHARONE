      ...
      <div class="content-wrapper">
        <section class="content">
          <div class="container bg-3 ">  
            <div class="row text-">
				<?php echo form_open("doctor/pathtest/unit",'class="form-horizontal formbody" id="search_form" method="get"');  ?>
				<div class="row mainheadlinefirstrow">
					<div class="col-md-12 mainheadlinefirst">Basic Filter
					<a  href="<?php echo base_url();?>doctor/pathtest/addunit" class="btn btn-info" style="float:right;" id="submit" >Add Unit</a>
					</div>
                </div>
                <div class="row">
                  <div class="col-md-12">
                    <div class="form-group">
                      ...
                      <label class="control-label col-sm-1 label-name" for="email">Unit </label>
                        ...
                        { 
                            echo anchor("doctor/pathtest/unit/",'<span>Clear Search</span>');    
                        } 
                        ?>
                    </div>
				...
				<?php echo form_close();?>
				<h4 style="font-weight:600;margin-bottom:20px;">Unit List</h4>
				  ...
				  <table class="table table-hover table-bordered table-bordered" id='exportTable' style="border:none;">
					<thead>
					  <tr>
						...
						<th class="tableheaddata">Unit Name</th>
					...
					<tbody id="tviewtablebody">
					  ...
					  {	
					   ...
					   <?php 
						echo "<td><a href=".base_url()."doctor/pathtest/editunit/".$p->unit_id." style=color:#11ff00;><span class='glyphicon glyphicon-edit'></span></a></td>";
						echo "<td><a href=".base_url()."doctor/pathtest/unit_delete?unit_id=".$p->unit_id." style=color:red;><span class='glyphicon glyphicon-trash'></span></a></td>";
						echo"</tr>";
					  }
					  ?>
					</tbody>
