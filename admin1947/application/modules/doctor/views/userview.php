...
?>
        ...
        <div class="form-group">
			...
			<div class="form-group">
			  <label class="control-label col-sm-4 label-name" for="email">Doctor Name<span class="starspan"></span></label>
			  <div class="col-sm-7">
				<input type="text" class="form-control" id="usermobile" name="mobile"    value="<?php echo $row->fname;?>">
			  </div>
			</div>
		...
		<div class="form-group">
			...
			<div class="col-sm-1"></div>
			  ...
			  <div class="col-sm-7">
				<input type="text" class="form-control" id="useremail" name="password" value="<?php echo $row->name;?>">
			  </div>
			</div>	
