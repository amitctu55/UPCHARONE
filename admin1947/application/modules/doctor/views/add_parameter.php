				...
				<div class="container bg-3 ">  
					<div class="row text-">
						<div class="container">
							...
							<form class="form-horizontal formbody" id='mainform' action="<?=base_url()?>doctor/pathtest/addparameter"  method="post" enctype="multipart/form-data">
								<!--Basic Details-->
								...
								<div class="row">
											...
											<div class="col-sm-8">
												<select name="unit_id" class="form-control input-sm" id="unit_id">
													...
													<?php if(is_array($unit) && !empty($unit)){
														foreach($unit as $val){?>
													<option value="<?php echo $val['unit_id']?>" <?php if(set_value('unit_id')==$val['unit_id']){ echo "selected";}?>><?php echo $val['unit_name']?></option>
													<?php }} ?>
												</select>
									...
									<div class="col-md-6">
										<div class="form-group">
											...
											<div class="col-sm-8">
												<input type="text" class="form-control input-sm" id="parameter_name" value="<?php echo set_value('parameter_name');?>" name="parameter_name" data-validation="required"
												data-validation-error-msg="This Field is required" value="<?=set_value('parameter_name');?>">
									...
									<div class="col-md-6">
										<div class="form-group">
											...
											<div class="col-sm-8">
												<input type="text" class="form-control input-sm" id="reference_range" value="<?php echo set_value('reference_range');?>" name="reference_range" data-validation="required"
									...
									<div class="col-md-6">
										<div class="form-group">
											...
											<div class="col-sm-8">
												<input type="text" class="form-control input-sm" id="description" value="<?php echo set_value('description');?>" name="description" data-validation="required"
