  ...
  <div class="content-wrapper">
    <section class="content">
      <div class="container bg-3 ">  
        <div class="row text-">
            <form class="form-horizontal formbody" id='mainform' action="<?=base_url()?>doctor/appointment/doctorwise" method="get" enctype="multipart/form-data">
					...
					<div class="col-md-12">
						<div class="form-group">
							...
							<div class="col-sm-3">
								...
								{ 
									echo anchor("doctor/appointment/doctorwise/",'<span>Clear Search</span>');    
								} 
								?>
							</div>
						</div>
			...
			<table class="table table-hover table-bordered table-bordered" id='example' style="border:none;">
				...
				<tbody id="tviewtablebody">
					...
					foreach($doctor as $p)
					{
						...
						echo "<td><a href='".base_url()."doctor/appointment/patient/".$p->id."' style=color:red;>Appointment</a></td>";
						echo"</tr>";
					}
					?>
				</tbody>
