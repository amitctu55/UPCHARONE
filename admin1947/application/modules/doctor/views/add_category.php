				...
				<div class="container bg-3 ">  
					<div class="row text-">
						<div class="container">
							...
							<h4 class="mainhead">Category</h4>
							<form class="form-horizontal formbody" id='mainform' action="<?=base_url()?>doctor/pathtest/addcategory"  method="post" enctype="multipart/form-data">
								<!--Basic Details-->
								...
								<div class="row">
									<div class="col-md-6">
										<div class="form-group">
										  ...
										  <div class="col-sm-7">
											<input type="text" class="form-control input-sm" id="category_name" value="<?php echo set_value('category_name');?>" name="category_name" data-validation="required"
											data-validation-error-msg="This Field is required" value="<?=$this->session->userdata('category_name');?>">
