				...
				<div class="container bg-3 ">  
					<div class="row text-">
						<div class="container">
							...
							<form class="form-horizontal formbody" id='mainform' action="<?=base_url()?>doctor/pathtest/editunit/<?php echo $res->unit_id; ?>"  method="post" enctype="multipart/form-data">
								<!--Basic Details-->
								...
								<div class="row">
									<div class="col-md-6">
										<div class="form-group">
										  ...
										  <div class="col-sm-7">
											<input type="text" class="form-control input-sm" id="unit_name" value="<?php echo set_value('unit_name',$res->unit_name);?>" name="unit_name" >
