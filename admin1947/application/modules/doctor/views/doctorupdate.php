							...
							<div class="row">
								...
								<div class="col-md-4">
									<div class="form-group">
								  	...
								  	<div class="col-sm-7">
										<select class="form-control input-sm" id="city" data-validation="required" data-validation-error-msg="This Field is required" name="city">
											<?php
							...
							<div class="row">
								...
								<div class="col-md-4">
									<div class="form-group">
									  	...
									  	<div class="col-sm-7">
										 	<select class="form-control input-sm" id="council" data-validation="required" data-validation-error-msg="This Field is required" name="council">
											<?php
								...
								<div class="col-md-4">
									<div class="form-group">
									  	...
									  	<div class="col-sm-7">
									  		<select class="form-control input-sm" id="qualification" data-validation="required"	data-validation-error-msg="This Field is required" name="qualification[]" multiple >
											<?php
								...
								<div class="col-md-4">
									<div class="form-group">
									  	...
									  	<div class="col-sm-7">
									  		<select class="form-control input-sm  show-menu-arrow " id="specialisation[]" data-validation="required"	data-validation-error-msg="This Field is required" name="specialisation[]" multiple  data-actions-box="true"  readonly >
												<?php
							...
							<div class="row">
								<div class="col-md-4">
									<div class="form-group">
									  	...
									  	<div class="col-sm-7">
											...
											<div class="container">
													<?php	$product_path = "public/assets/upload/".$profile_dr->drimage;
													if($profile_dr->drimage !='') { ?>
						  						<a data-toggle="modal" data-target="#myModal<?php echo $profile_dr->id;?>">View Image</a>

											  	<!-- The Modal -->
											  	<div class="modal" id="myModal<?php echo $profile_dr->id;?>">
								...
								<div class="col-md-4">
									<div class="form-group">
				  						...
				  						<div class="col-sm-7">
											...
											<div class="container">
													<?php	$product_path = "public/assets/upload/".$profile_dr->id_proof;
													if($profile_dr->id_proof !='') { ?>
						  						<a data-toggle="modal" data-target="#myModal1<?php echo $profile_dr->id;?>">View Image</a>

											  	<!-- The Modal -->
											  	<div class="modal" id="myModal1<?php echo $profile_dr->id;?>">
											    	<div class="modal-dialog">
											      		<div class="modal-content">
											        		<!-- Modal Header -->
											        		<div class="modal-header">
								...
								<div class="col-md-4">
									<div class="form-group">
								  		...
								  		<div class="col-sm-7">
											<input type="file" class="form-control input-sm" id="regpoof" name="regpoof" data-validation-error-msg="This Field is required">
											<div class="container">
													<?php	$product_path = "public/assets/upload/".$profile_dr->mic_proof;
													if($profile_dr->mic_proof !='') { ?>
						  						<a data-toggle="modal" data-target="#myModal2<?php echo $profile_dr->id;?>">View Image</a>

											  	<!-- The Modal -->
											  	<div class="modal" id="myModal2<?php echo $profile_dr->id;?>">
											    	<div class="modal-dialog">
											      		<div class="modal-content">
											        		<!-- Modal Header -->
											        		<div class="modal-header">
							...
							<div class="row">
								<div class="col-md-12">
									<div class="form-group">
									  	...
									  	<div class="col-sm-8">
											<textarea class="form-control input-sm" id="about" name="about" data-validation=""	data-validation-error-msg="This Field is required" ><?=$profile_dr->about;?></textarea>
									  	</div>
									</div>
								</div>
							</div>
									...
									<div class="col-md-4">
										<div class="form-group">
										  	...
										  	<div class="col-sm-7" id="cemp">
												<select class="form-control input-sm" id="clinic" name="clinic[0]" ></select>
