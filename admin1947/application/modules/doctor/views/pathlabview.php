...
<br>  
  ...
  <div class="row text-">
	...
	<table class="table table-hover table-bordered table-bordered" id='newdatatable' style="border:none;">
    <thead>
      <tr>
...
<script src="//ajax.googleapis.com/ajax/libs/jquery/1.10.2/jquery.min.js"></script>
    ...
    $(document).ready(function () {
        ...
        $('#newdatatable').DataTable({
            ...
            "serverSide": true,
            "ajax": {
                url: '<?=base_url();?>others/data_view/pathologyview',
                type: 'POST',
				data: function(d){
		...
		$("#newdatatable").on('click','.actionapprove',function(e){
			e.preventDefault();
			var $t = $(this);
			var key=$(this).attr('data-upcahr-did');	
			var uri='<?=base_url()?>doctor/pathlabreg/<?=$module;?>approve';
			$.ajax({
				 type:"post", 
				 url: uri,
				 dataType:'json',
		...
		$("#newdatatable").on('click','.actionverify',function(e){
			e.preventDefault();
			var $t = $(this);
			var key=$(this).attr('data-upcahr-did');	
			var uri='<?=base_url()?>doctor/pathlabreg/<?=$module;?>verify';
			$.ajax({
				 type:"post", 
				 url: uri,
				 dataType:'json',
