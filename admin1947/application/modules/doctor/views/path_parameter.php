      ...
      <div class="content-wrapper">
        <section class="content">
          <div class="container bg-3 ">  
            <div class="row text-">
				<?php echo form_open("doctor/pathtest/parameter",'class="form-horizontal formbody" id="search_form" method="get"');  ?>
				<div class="row mainheadlinefirstrow">
					<div class="col-md-12 mainheadlinefirst">Basic Filter
					<a  href="<?php echo base_url();?>doctor/pathtest/addparameter" class="btn btn-info" style="float:right;" id="submit" >Add Parameter</a>
					</div>
                </div>
                <div class="row">
                  <div class="col-md-12">
                    <div class="form-group">
                      ...
                      <label class="control-label col-sm-1 label-name" for="email">Parameter </label>
						<div class="col-sm-3">
                        <input type="text" class="form-control input-sm"  name="keyword" value="<?php echo $this->input->get_post('pathtest_id');?>">
						</div>
						<div class="col-sm-3">
                        ...
                        { 
                            echo anchor("doctor/pathtest/parameter/",'<span>Clear Search</span>');    
                        } 
                        ?>
                    </div>
				...
				<?php echo form_close();?>
				<h4 style="font-weight:600;margin-bottom:20px;">Parameter List</h4>
				  ...
				  <table class="table table-hover table-bordered table-bordered" id='exportTable' style="border:none;">
					<thead>
					  <tr>
						...
						<th class="tableheaddata">Edit</th>
					...
					<tbody id="tviewtablebody">
					  ...
					  {	
						echo"<tr>";
						echo"<td>".$p->parameter_id."</td>";
						echo"<td>".$p->parameter_name."</td>";
						echo"<td>".$p->reference_range."</td>";
						echo"<td>".$p->unit_name."</td>";
						echo"<td>".$p->description."</td>";
						?>
						<td><?php if($p->status=='0'){ echo '<span style="color:red;">In-Active</span>'; } else{ echo '<span style="color:green;">Active</span>'; } ?></td>
					   <?php 
						echo "<td><a href=".base_url()."doctor/pathtest/editparameter/".$p->parameter_id." style=color:#11ff00;><span class='glyphicon glyphicon-edit'></span></a></td>";
						echo "<td><a href=".base_url()."doctor/pathtest/parameter_delete?parameter_id=".$p->parameter_id." style=color:red;><span class='glyphicon glyphicon-trash'></span></a></td>";
						echo"</tr>";
					  }
					  ?>
					</tbody>
