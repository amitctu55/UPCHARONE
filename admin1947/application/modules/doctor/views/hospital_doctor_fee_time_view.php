		...
		<div class="content-wrapper">
			...
			<section class="content">
				...
				<div class="container bg-3 "> 
					<?php $practice_id = $this->uri->segment(4);
					echo form_open("doctor/clinicreg/doctor_fee_time/".$practice_id."",'class="form-horizontal formbody" id="search_form" method="get"');  ?>
						...
						<div class="col-md-12">
							<div class="form-group">
								...
								<div class="col-sm-3">
									...
									{ 
										echo anchor("doctor/clinicreg/doctor_fee_time/".$practice_id."",'<span>Clear Search</span>');    
									} 
									?>
								</div>
							</div>
					...
					echo form_open_multipart("doctor/clinicreg/doctor_fee_time/".$practice_id."", $att);?>
						...
						<table class="table table-hover table-bordered table-bordered" id='neodatatable' style="border:none;">
							<thead>
								<tr>
									...
									<th class="tableheaddata">From Time</th>
									<th class="tableheaddata">To Time</th>
									<th class="tableheaddata">Fee</th>
									<th class="tableheaddata">Max Patient</th>
									<th class="tableheaddata">Monday</th>
									<th class="tableheaddata">Tuesday</th>
									<th class="tableheaddata">Wednesday</th>
									<th class="tableheaddata">Thursday </th>
									<th class="tableheaddata">Friday </th>
									<th class="tableheaddata">Saturday </th>
									<th class="tableheaddata">Sunday </th>
								</tr>
							</thead>
							<?php
							...
							<tbody>
								<tr>
									...
									<td class="tableheaddata"><?php echo $val['from_timing'];?></td>
									<td class="tableheaddata"><?php echo $val['to_timing']?></td>
									<td class="tableheaddata"><?php echo $val['consultation_fee']?></td>
									<td class="tableheaddata"><?php echo $val['max_patient']?></td>
									<td class="tableheaddata"><?php if($val['M']==1){ echo "Available"; }else { echo "Not Available";}?></td>
									<td class="tableheaddata"><?php if($val['T']==1){ echo "Available"; }else { echo "Not Available";}?></td>
									<td class="tableheaddata"><?php if($val['W']==1){ echo "Available"; }else { echo "Not Available";}?></td>
									<td class="tableheaddata"><?php if($val['TH']==1){ echo "Available"; }else { echo "Not Available";}?></td>
									<td class="tableheaddata"><?php if($val['F']==1){ echo "Available"; }else { echo "Not Available";}?></td>
									<td class="tableheaddata"><?php if($val['SA']==1){ echo "Available"; }else { echo "Not Available";}?></td>
									<td class="tableheaddata"><?php if($val['S']==1){ echo "Available"; }else { echo "Not Available";}?></td>
								</tr>
							</tbody>
							<?php 
							}
