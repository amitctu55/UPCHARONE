		...
		<div class="content-wrapper">
			...
			<section class="content">
				...
				<div class="container bg-3 ">
					<div class="row text-">
						<div class="container">
							<h4 class="mainhead">Booking Test Details</h4>
							...
							<div class="row">
								<div class="col-md-12">
									<div class="form-group">
										...
										<div class="col-sm-4">
											<input type="text" name="pathlab_name"  id='pathlab_name' class="form-control" readonly value="<?php echo set_value('pathlab_name',$booking->pathlab_name);?>" placeholder="Pathology Name">
										...
										<div class="col-sm-4">
											<input type="text" name="city_name"  id='city_name' class="form-control" readonly value="<?php echo set_value('city_name',$booking->city_name);?>" placeholder="City Name">
							...
							<div class="row mainheadlinefirstrow">
								<div class="col-md-12 mainheadlinefirst">Customer Details</div>
							</div>
							<div class="row">
								<div class="col-md-12">
									<div class="form-group">
										...
										<div class="col-sm-4">
											<input type="text" name="patient_name"  id='patient_name' class="form-control" readonly value="<?php echo set_value('patient_name',$booking->patient_name);?>" placeholder="Patient Name">
										...
										<div class="col-sm-4">
											<input type="text" id='patient_mobile' name="patient_mobile" class="form-control" readonly value="<?php echo set_value('patient_mobile',$booking->patient_mobile);?>"  placeholder="Mobile Number" >
									...
									<div class="form-group">
										...
										<div class="col-sm-4">
											<input type="text" name="patient_email" class="form-control" readonly value="<?php echo set_value('patient_email',$booking->patient_email);?>"  placeholder="Email Id">
							...
							<div class="table-responsive">
								<table class="table table-hover table-bordered table-bordered"  style="border:none;">
									<thead>
										<tr>
											<th>Sr. No.</th>
									...
									<tbody>
										<tr>
											...
											<td class="tableheaddata">Rs. <?php echo $val['amount']?></td>
										</tr>
									</tbody>
									<?php $i++;
									}
									...
									<tfoot>
									  <tr>
										<th class="tableheaddata" colspan="4" align="right" ><center>Total</center></th>
										<th class="tableheaddata">Rs. <?php echo $booking->total_amount?></th>
									  </tr>
									</tfoot>
								</table>
							</div>
