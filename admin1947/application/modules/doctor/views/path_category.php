      ...
      <div class="content-wrapper">
        <section class="content">
          <div class="container bg-3 ">  
            <div class="row text-">
				<?php echo form_open("doctor/pathtest/category",'class="form-horizontal formbody" id="search_form" method="get"');  ?>
				<div class="row mainheadlinefirstrow">
					<div class="col-md-12 mainheadlinefirst">Basic Filter
					<a  href="<?php echo base_url();?>doctor/pathtest/addcategory" class="btn btn-info" style="float:right;" id="submit" >Add Category</a>
					</div>
                </div>
                <div class="row">
                  <div class="col-md-12">
                    <div class="form-group">
                      ...
                      <label class="control-label col-sm-1 label-name" for="email">Category </label>
						<div class="col-sm-3">
                        ...
                        { 
                            echo anchor("doctor/pathtest/category/",'<span>Clear Search</span>');    
                        } 
                        ?>
                    </div>
				...
				<?php echo form_close();?>
				<h4 style="font-weight:600;margin-bottom:20px;">Category List</h4>
				  ...
				  <table class="table table-hover table-bordered table-bordered" id='exportTable' style="border:none;">
					...
					<tbody id="tviewtablebody">
					  ...
					  {	
					   ...
					   <?php 
						echo "<td><a href=".base_url()."doctor/pathtest/editcategory/".$p->category_id." style=color:#11ff00;><span class='glyphicon glyphicon-edit'></span></a></td>";
						echo "<td><a href=".base_url()."doctor/pathtest/category_delete?category_id=".$p->category_id." style=color:red;><span class='glyphicon glyphicon-trash'></span></a></td>";
						echo"</tr>";
					  }
					  ?>
					</tbody>
