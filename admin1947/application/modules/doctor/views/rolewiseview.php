    		...
    		<section class="content">
				<div class="container bg-3 ">
  					<div class="row text-">
  						...
  						<h4 style="font-weight:600;margin-bottom:20px;">Role List</h2>	<br>
  					</div>
  					...
  					<table class="table table-hover table-bordered table-bordered" id='example' style="border:none;">
    					<thead>
					      	<tr>
						        ...
						        <th class="tableheaddata">Module Access</th>
					    ...
					    <tbody id="tviewtablebody">
					 			<?php 
					   			...
					   			{
									echo"<tr>";
									echo"<td>".$p['level_id']."</td>";
									echo"<td>".$p['level_name']."</td>";
									$module = explode(',',$p['module']);
								...
								?>
									...
									<?php 
									echo"<td>".formatedate($p['added_date'])."</td>";
									if($p['isStatus']==1){
									echo"<td>".'<font color="green">Approved</font>'."</td>";
									}else{echo"<td>".'<font color="red">Not Approved</font>'."</td>";}
									echo "<td>
									<a href='rolewiseupdate/".$p['level_id']."' style=color:red;>Edit</a>
									</td>";?>
									<td> <?php if($p['type']!='1') echo "<a href='deleterole/".$p['level_id']."' style=color:red;>Delete</a>";?>
									</td>
									<?php   echo"</tr>";
									echo"</tr>";
					   			} ?>
