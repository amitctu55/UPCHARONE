...
<div class="container">
	...
	<table class="table table-bordered" id='example' style="border:none;margin-top: 34px;">
    <thead>
      <tr>
        ...
        <th class="tableheaddata">BLOOD GROUP</th>
...
echo "<td><a href='delete?USERID=".$p->USERID."' style=color:red;>Delete</a></td>";
echo"</tr>";
