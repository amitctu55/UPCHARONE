			...
			<div class="content-wrapper">
				...
				<section class="content">
					<div class="container bg-3 ">
						<?php echo form_open("users/premium/",'class="form-horizontal formbody" id="search_form" method="get"');  ?>
						<div class="row mainheadlinefirstrow">
							<div class="col-md-12 mainheadlinefirst">Basic Filter
								<a  href="<?php echo base_url();?>users/premium/add" class="btn btn-info" style="float:right;" id="submit" >Add Premium</a>
							</div>
						</div>
						<div class="row">
							<div class="col-md-12">
								<div class="form-group">
									...
									<div class="col-sm-3">
										...
										{ 
											echo anchor("users/premium/",'<span>Clear Search</span>');    
										} 
										?>
									</div>
								</div>
						...
						<div class="table-responsive">
							<table class="table table-hover table-bordered table-bordered" id='example' style="border:none;">
								...
								<tbody id="tviewtablebody">
									...
									<tr>
										<td>
											<input style="width:15px;" type="checkbox" name="arr_ids[]" value="<?php echo $val['premium_id'];?>" id="check-all" class="flat">
										</td>
										...
										<td>
											<?php
											if($val['description']!=''){ ?>
											<a data-toggle="modal" style="color:red;" data-target="#myModal<?php echo $val['premium_id'];?>">View</a>
											<!-- The Modal -->
											<div class="modal" id="myModal<?php echo $val['premium_id'];?>">
										...
										<td>
											...
											if($val['image']!=''){ ?>
											<a data-toggle="modal" style="color:red;" data-target="#myModal1<?php echo $val['premium_id'];?>">View</a>
											<!-- The Modal -->
											<div class="modal" id="myModal1<?php echo $val['premium_id'];?>">
												<div class="modal-dialog">
													<div class="modal-content">
														<!-- Modal Header -->
														<div class="modal-header">
										...
										<td><a href="<?php echo base_url();?>users/premium/update/<?php echo $val['premium_id']; ?>" style="color:red;">Edit</a></td>
									</tr>
									<?php 
									} 
									}?>
