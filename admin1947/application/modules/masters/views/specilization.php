...
<br>  
  ...
  <div class="row text">
	...
	<?php echo form_open("masters/specilization",'class="form-horizontal formbody" id="search_form" method="get"');  ?>
						...
						<div class="col-md-12">
							<div class="form-group">
								...
								<div class="col-sm-3">
									...
									{ 
										echo anchor("masters/specilization/",'<span>Clear Search</span>');    
									} 
									?>
								</div>
							</div>
	...
	<?php 
		...
		foreach($specilization as $rowdata){
