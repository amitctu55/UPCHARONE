...
<br>  
  ...
  <div class="row text">
	...
	<form action="<?=base_url()?>masters/coursetype/create" method="post" id="myform">
	<div class="formheader">
		Course Type Master
	</div>
	<div class="formdiv">
		<div class="form-group">
		  <label for="text">Course Type Name:</label>
		  <input type="text" class="form-control" id="coursetype" placeholder="Enter coursetype name" name="coursetype" data-validation="required"
    ...
    <thead>
      <tr>
        <th class="tableheaddata">Course Type ID</th>
        <th class="tableheaddata">Course Type</th>
    ...
    <tbody>
	<?php 
		$getlists=$this->db->get_where('master_course_type');
	...
	?>
      <tr class="active">
        <td class="tabledata"><?=$rowdata->course_type_id;?></td>
        <td class="tabledata"><?=$rowdata->course_type_name;?></td>
		
        <td class="tabledata"><a href="#" class="statuscng " id="ch<?=$rowdata->course_type_id;?>" data-uid="<?=$rowdata->course_type_id;?>" style="cursor:pointer"><span class="<?=$statusclass?>" ><?=$statusvalue?></span></a></td>
        <td class="tabledata" id="kamal"><a href="#" style="cursor:pointer" class="select" data-uid="<?=base64_encode($rowdata->course_type_id)?>" data-name="<?=$rowdata->course_type_name;?>">Select</a></td>
		
        <td class="tabledata"><a href="#" style="cursor:pointer" class="delete" data-uid="<?=$rowdata->course_type_id;?>">Delete</a></td>
      </tr>
		<?php } ?>
    </tbody>
  </table>
...
$(document).ready(function(){
    ...
    $(".delete").click(function(){
		...
		if(c)
		{
			...
			var uri='<?=base_url()?>masters/coursetype/delete/'+uid
			$.ajax({
			 type:"post", 
			 url: uri,
...
$(document).ready(function(){
	$(".statuscng").click(function(){
		...
		var uri='<?=base_url()?>masters/coursetype/statusupdate';
			$.ajax({
			 type:"post", 
			 url: uri,
			 data:{uid:uid},
