...
<br>  
  ...
  <div class="row text">
	...
	<br>
	<br>
	<?php echo form_open("masters/city",'class="form-horizontal formbody" id="search_form" method="get"');  ?>
						...
						<div class="col-md-12">
							<div class="form-group">
								...
								<div class="col-sm-3">
									...
									{ 
										echo anchor("masters/city/",'<span>Clear Search</span>');    
									} 
									?>
								</div>
							</div>
