          ...
          <div class="master-card">
            <div class="master-card-header">
              ...
              <span style="font-size: 12px; color: #64748b; font-weight: 500;">
                Total Records: <strong><?=(isset($total_rows) ? $total_rows : (isset($config['total_rows']) ? $config['total_rows'] : (is_array($city) ? count($city) : 0)));?></strong>
              </span>
            </div>

            <div class="master-card-body" style="padding: 16px 20px;">
              <!-- Search & Filters Toolbar -->
              <form action="<?=base_url('masters/city')?>" method="get" id="search_form" class="master-toolbar" style="display: flex; align-items: center; justify-content: space-between; flex-wrap: wrap; gap: 10px;">
                ...
                <div style="display: flex; align-items: center; gap: 8px; flex-grow: 1; max-width: 380px; justify-content: flex-end;">
                  ...
                  <?php if($this->input->get('keyword')!='' || ($this->input->get('status')!==null && $this->input->get('status')!='')): ?>
                    <a href="<?=base_url('masters/city')?>" class="btn btn-sm btn-default" title="Reset Filters" style="border-radius: 6px; height: 34px; line-height: 22px; white-space: nowrap;">
