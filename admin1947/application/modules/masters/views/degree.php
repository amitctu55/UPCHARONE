          ...
          <div class="master-card">
            <div class="master-card-header">
              ...
              <span style="font-size: 12px; color: #64748b; font-weight: 500;">
                Total Records: <strong><?=(isset($config['total_rows']) ? $config['total_rows'] : count($degree));?></strong>
              </span>
            </div>

            <div class="master-card-body" style="padding: 16px 20px;">
              <!-- Search & Records Per Page Toolbar -->
              <form action="<?=base_url('masters/degree')?>" method="get" id="search_form" class="master-toolbar">
                ...
                <div style="display: flex; align-items: center; gap: 8px; flex-grow: 1; max-width: 380px;">
                  ...
                  <?php if($this->input->get_post('keyword')!=''): ?>
                    <a href="<?=base_url('masters/degree')?>" class="btn btn-sm btn-default" title="Clear Search" style="border-radius: 6px; height: 34px; line-height: 22px;">
