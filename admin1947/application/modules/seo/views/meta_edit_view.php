					...
					<div class="col-md-12 col-sm-12 col-xs-12">
						<div class="x_panel">
							...
							<div class="form-group" >
								...
								<div class="col-md-3 col-sm-3 col-xs-12">
									<input type="text" name="page_url" size="40" class="form-control" value="<?php echo set_value('page_url',$res['page_url']);?>">
							...
							<div class="form-group" >
								...
								<div class="col-md-6 col-sm-6 col-xs-12">
									<textarea name="meta_title" rows="5" class="form-control" id="title" ><?php echo set_value('meta_title',$res['meta_title']);?></textarea>		
							...
							<div class="form-group" >
								...
								<div class="col-md-6 col-sm-6 col-xs-12">
									<textarea name="meta_keyword" rows="5" class="form-control" id="keyword" ><?php echo set_value('meta_keyword',$res['meta_keyword']);?></textarea>
							...
							<div class="form-group" >
								...
								<div class="col-md-6 col-sm-6 col-xs-12">
									<textarea name="meta_description" rows="5" class="form-control" id="description" ><?php echo set_value('meta_description',$res['meta_keyword']);?></textarea>
							...
							<div class="form-group">
								<div class="col-md-6 col-sm-6 col-xs-12 col-md-offset-3">
									<input type="submit" name="sub" value="Save" class="btn btn-sm btn-success" class="button2" />
