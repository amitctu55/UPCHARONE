<div class="content-wrapper" style="background: #f8fafc; min-height: 900px;">
      ...
      <div>
        <div style="display: flex; align-items: center; gap: 10px; margin-bottom: 6px;">
          ...
          <h1 style="font-size: 24px; font-weight: 800; color: #0f172a; margin: 0; font-family: 'Inter', -apple-system, sans-serif;">
            Add New SEO Meta Tag
          </h1>
        </div>
        <p style="margin: 0; color: #64748b; font-size: 13.5px;">Configure search engine metadata, Open Graph cards, and structured schema markup for a target platform URL</p>
      </div>
  ...
  <section class="content" style="padding: 12px 24px 36px;">
    ...
    <form action="<?=base_url('seo/meta/add');?>" method="post" id="metaForm">
      <div class="row">
          ...
          <div style="background: #ffffff; border-radius: 14px; border: 1px solid #e2e8f0; box-shadow: 0 2px 6px rgba(0,0,0,0.04); overflow: hidden; margin-bottom: 24px;">
            ...
            <div class="tab-content" style="padding: 24px;">
              ...
              <div class="tab-pane active" id="tabCore">
                ...
                <div class="form-group" style="margin-bottom: 20px;">
                  ...
                  <div style="display: flex; align-items: center; border-radius: 8px; border: 1px solid #cbd5e1; overflow: hidden; height: 42px; background: #fff;">
                    ...
                    <input type="text" name="page_url" id="inp_page_url" class="form-control" value="<?=set_value('page_url');?>" placeholder="doctors/delhi/cardiologist" style="border: none; box-shadow: none; height: 100%; font-size: 14px; padding: 0 14px; font-family: monospace;" required>
                  </div>
                  <span style="font-size: 12px; color: #64748b; display: block; margin-top: 4px;">Enter relative path (e.g. <code>doctors</code>, <code>hospitals/mumbai</code>, <code>home</code> for homepage). Leading domain and slashes are automatically stripped.</span>
                ...
                <div class="form-group" style="margin-bottom: 20px;">
                  ...
                  <input type="text" name="meta_title" id="inp_meta_title" class="form-control" value="<?=set_value('meta_title');?>" placeholder="e.g. Best Cardiologists in Delhi | Book Verified Doctor - Upchar" style="height: 44px; border-radius: 8px; border: 1px solid #cbd5e1; font-size: 14px; padding: 8px 14px;" required>
                ...
                <div class="form-group" style="margin-bottom: 20px;">
                  ...
                  <input type="text" name="meta_keyword" id="inp_meta_keyword" class="form-control" value="<?=set_value('meta_keyword');?>" placeholder="cardiologist delhi, heart hospital, doctor appointment, upchar healthcare" style="height: 42px; border-radius: 8px; border: 1px solid #cbd5e1; font-size: 14px; padding: 8px 14px;">
                ...
                <div class="form-group" style="margin-bottom: 10px;">
                  ...
                  <div style="display: flex; gap: 20px; align-items: center; background: #f8fafc; padding: 12px 18px; border-radius: 8px; border: 1px solid #e2e8f0;">
                    <label style="margin: 0; font-size: 13.5px; font-weight: 600; color: #15803d; cursor: pointer; display: flex; align-items: center; gap: 6px;">
                      <input type="radio" name="status" value="1" checked style="width: 16px; height: 16px;"> Active (Live in HTML head)
                    </label>
                    <label style="margin: 0; font-size: 13.5px; font-weight: 600; color: #b91c1c; cursor: pointer; display: flex; align-items: center; gap: 6px;">
                      <input type="radio" name="status" value="0" style="width: 16px; height: 16px;"> Inactive (Draft mode)
                    </label>
                  </div>
                </div>
              </div>
              ...
              <div class="tab-pane" id="tabRobots">
                <div class="form-group" style="margin-bottom: 20px;">
                  ...
                  <select name="robots_meta" class="form-control" style="height: 42px; border-radius: 8px; border: 1px solid #cbd5e1; font-size: 14px;">
                    <option value="index, follow" selected>index, follow (Default - Allow search engines to index and follow links)</option>
                    <option value="noindex, follow">noindex, follow (Exclude from search results, but follow internal links)</option>
                    <option value="index, nofollow">index, nofollow (Index page in search results, do not follow links)</option>
                    <option value="noindex, nofollow">noindex, nofollow (Strictly private - No search indexing, no link following)</option>
                  </select>
                </div>
                ...
                <div class="form-group" style="margin-bottom: 20px;">
                  ...
                  <input type="url" name="canonical_url" id="inp_canonical_url" class="form-control" value="<?=set_value('canonical_url');?>" placeholder="https://upchar.info/preferred-url-slug" style="height: 42px; border-radius: 8px; border: 1px solid #cbd5e1; font-size: 14px; padding: 8px 14px;">
                  <span style="font-size: 12px; color: #64748b; display: block; margin-top: 4px;">Leave empty to automatically use the page URL as the canonical tag. Specify if this is a duplicate or parameterized variation.</span>
                </div>
              </div>
              ...
              <div class="tab-pane" id="tabSocial">
                <div class="form-group" style="margin-bottom: 20px;">
                  ...
                  <input type="text" name="og_title" id="inp_og_title" class="form-control" value="<?=set_value('og_title');?>" placeholder="Leave empty to use SEO Title" style="height: 42px; border-radius: 8px; border: 1px solid #cbd5e1; font-size: 14px; padding: 8px 14px;">
                </div>
                ...
                <div class="form-group" style="margin-bottom: 20px;">
                  ...
                  <textarea name="og_description" id="inp_og_description" rows="3" class="form-control" placeholder="Leave empty to use Meta Description" style="border-radius: 8px; border: 1px solid #cbd5e1; font-size: 14px; padding: 10px 14px;"><?=set_value('og_description');?></textarea>
                </div>
                ...
                <div class="form-group" style="margin-bottom: 20px;">
                  ...
                  <input type="url" name="og_image" id="inp_og_image" class="form-control" value="<?=set_value('og_image');?>" placeholder="https://upchar.info/public/assets/images/banner.jpg" style="height: 42px; border-radius: 8px; border: 1px solid #cbd5e1; font-size: 14px; padding: 8px 14px;">
                ...
                <div class="form-group" style="margin-bottom: 20px;">
                  ...
                  <select name="og_type" class="form-control" style="height: 42px; border-radius: 8px; border: 1px solid #cbd5e1; font-size: 14px;">
                    <option value="website" selected>website (General Webpage)</option>
                    <option value="article">article (Blog / Health Article)</option>
                    <option value="profile">profile (Doctor / Staff Profile)</option>
                  </select>
                </div>
              </div>
              ...
              <div class="tab-pane" id="tabSchema">
                ...
                <textarea name="schema_markup" id="inp_schema_markup" rows="8" class="form-control" placeholder='{&#10;  "@context": "https://schema.org",&#10;  "@type": "MedicalOrganization",&#10;  "name": "Upchar Healthcare"&#10;}' style="font-family: monospace; font-size: 13px; background: #0f172a; color: #38bdf8; border-radius: 8px; padding: 14px;"><?=set_value('schema_markup');?></textarea>
                <span style="font-size: 12px; color: #64748b; display: block; margin-top: 6px;">This script will be injected automatically inside <code>&lt;script type="application/ld+json"&gt;</code> in the webpage header.</span>
              </div>
            </div>
            ...
            <div style="padding: 16px 24px; background: #f8fafc; border-top: 1px solid #e2e8f0; display: flex; justify-content: flex-end; gap: 12px;">
              ...
              <button type="submit" class="btn" style="background: #0d9488; color: #ffffff; font-weight: 700; padding: 10px 28px; border-radius: 8px; border: none; box-shadow: 0 4px 10px rgba(13,148,136,0.25);">
                <i class="fa fa-save" style="margin-right: 6px;"></i> Save SEO Meta Tag
              </button>
            </div>
          </div>
        </div>
              ...
              <div style="background: #ffffff; border: 1px solid #f1f5f9; border-radius: 10px; padding: 14px;">
                <div style="display: flex; align-items: center; gap: 6px; margin-bottom: 4px;">
                  ...
                  <div>
                    ...
                    <div style="font-size: 11px; color: #4d5156; word-break: break-all;" id="liveGoogleUrl">https://upchar.info/slug</div>
                  </div>
                </div>
