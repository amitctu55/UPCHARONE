...
$route['myappointments'] 				= 'home/myappointments';
$route['myappointents'] 				= 'home/myappointments';
...
$route['home/send_enquiry'] 			= 'home/send_enquiry';
$route['api/get-available-slots'] 		= 'home/app_conf_pop_time';
$route['get-available-slots'] 			= 'home/app_conf_pop_time';
$route['hospitalpanel/inquiries'] 		= 'hospitalpanel/inquiries';
$route['hospitalpanel/reply_inquiry'] 	= 'hospitalpanel/reply_inquiry';
$route['hospitalpanel/update_inquiry_status/(:any)/(:any)'] = 'hospitalpanel/update_inquiry_status/$1/$2';
...
$route['hospitallist'] 					= 'home/hospitallist';
$route['hospitals'] 					= 'home/hospitals';
$route['hospital'] 						= 'home/hospitals';
$route['medical'] 						= 'home/medical';
$route['medicine'] 						= 'home/medical';
$route['pharmacy'] 						= 'home/medical';
$route['doctors'] 						= 'home/doctors';
...
$route['mytest/quick_book'] 			= 'mytest/quick_book';
$route['mytest/(:any)'] 				= 'mytest/$1';
$route['diagnostic'] 					= 'mytest/index';
$route['pathlabview'] 					= 'mytest/index';
$route['pathlabview/(:any)'] 			= 'mytest/$1';
$route['pathology'] 					= 'mytest/index';
$route['pathology/quick_book'] 			= 'mytest/quick_book';
$route['pathology/(:any)'] 				= 'mytest/$1';
...
$route['payment/receipt/(:any)']            = 'payment/receipt/$1';
...
$route['admin1947/hr/recruitment/update_applicant']   = 'hr/update_candidate_stage';
$route['admin1947/hr/recruitment/save_job']           = 'hr/save_job';
$route['admin1947/hr/recruitment/save_candidate']     = 'hr/save_candidate';
$route['admin1947/hr/recruitment/onboard_candidate']  = 'hr/onboard_candidate';
$route['admin1947/hr/update_applicant']               = 'hr/update_candidate_stage';
$route['admin1947/hr/update_applicant_status']        = 'hr/update_candidate_stage';
