				...
				<div class="pag_cstm_panel_panel_ontent p-t-0">
                    <div class="row paddb40">
						<div class="col-sm-12 processsstep2">
							<a href='<?=base_url();?>pathlabpanel/addtest'><button type='submit' name='submit' style="letter-spacing: 1px;text-shadow: 3px -1px 2px #666;font-weight:900;color:white;background:#1fc61f;padding:9px 23px;border-radius: 23px;float: right;border:none;">Add Test</button></a>
							<h4>Manage Test</h4>
						</div>
						<div class="row paddb40">
                            <div class="col-sm-12 processsstep2">
								<?php echo form_open("pathlabpanel/pathtest/",'class="form-horizontal formbody" id="search_form" method="get"');  ?>
								<div class="col-md-3">
									<input style="border-radius: 23px;padding:0px 23px;" name='keyword' placeholder="Test Name, Amount" value="<?php echo $this->input->get_post('keyword')?>" >
								</div>
								<div class="col-md-3">
								...
								<div class="col-sm-1 col-xs-12">
									...
									{ 
										echo anchor("pathlabpanel/pathtest/",'<span>Clear Search</span>'); 	  
									} 
									?>
								</div>
								<?php echo form_close();?>
								<div class="col-sm-12 processsstep2">
									<div class="table-responsive">
										...
										echo form_open_multipart("pathlabpanel/pathtest/", $att);?> 
										<table id="datatable" class="table table-bordered" style="width:100%">
											...
											<tbody style="color:white;">
												...
												<?php echo"<td>".$val['category_name']."</td>";
												echo"<td>".$val['test_name']."</td>";
												echo"<td>".$val['short_name']."</td>";
												echo"<td>".$val['test_type']."</td>";
												echo"<td>".$val['sub_category']."</td>";
												echo"<td>".$val['method']."</td>";
												echo"<td>".$val['report_day']."</td>";
												echo"<td>".$val['charge_category']."</td>";
												echo"<td>".$val['code']."</td>";
												echo"<td>";?><?php echo $val['amount'];?> ₹.<?php echo "</td>";
												echo"<td>";?><?php echo $val['lab_price'];?> ₹.<?php echo "</td>";
												echo"<td>".
												...
												echo"<td>";?>
												<a style="color:red;" href="<?php echo base_url();?>pathlabpanel/edittest/<?php echo $val['id'];?>">Update</a></td>
												<?php echo"</tr>";
												}
												}else{
												?>
