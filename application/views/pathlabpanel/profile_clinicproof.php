    ...
    <div class="row">
        <div class="col-lg-12">
            ...
            <div style="display: flex; justify-content: space-between; align-items: center; flex-wrap: wrap; gap: 12px; margin-bottom: 20px;">
                <div>
                    <h2 style="font-size: 22px; font-weight: 700; color: #1e293b; margin: 0 0 4px 0;">
                        <i class="fa fa-shield" style="color: #00a896;"></i> Pathology Lab Verification
                    </h2>
                    <p style="color: #64748b; font-size: 13px; margin: 0;">Upload your Pathology / Diagnostic Lab ownership document to complete profile verification.</p>
                </div>
                <div>
                    <a href="<?=base_url('pathlabpanel/updateprofile');?>" class="btn btn-default" style="background: #ffffff; border: 1px solid #cbd5e1; color: #334155; font-weight: 600; border-radius: 8px; padding: 8px 18px;">
                        <i class="fa fa-arrow-left"></i> Back to Basic Profile
                    </a>
                </div>
            </div>
            ...
            <div class="row">
                    ...
                    <div class="pathlab-card">
                        <div class="pathlab-card-header">
                            <h3 class="pathlab-card-title">
                                <i class="fa fa-cloud-upload"></i> Upload Pathology Proof Document
                            </h3>
                            <span style="font-size: 12px; background: rgba(255,255,255,0.2); padding: 4px 10px; border-radius: 20px;">Step 2 of 4</span>
                        </div>
                        <div class="pathlab-card-body">
                            <form action="<?=base_url('pathlabpanel/profile_clinicproof');?>" method="post" enctype="multipart/form-data">
                                
                                <label class="path-form-label" style="font-size: 14px; font-weight: 700; color: #1e293b; margin-bottom: 10px; display: block;">
                                    Select Document Image / PDF File <span style="color: #ef4444;">*</span>
                                </label>

                                <!-- Drag & Drop File Upload Box -->
                                <div class="file-upload-dropzone" id="dropzone-box">
                                    <input type="file" name="images" id="proof_image_input" class="file-upload-input" accept="image/*,.pdf" <?=(empty($src) ? 'required' : '');?> onchange="handleFilePreview(this)">
                                ...
                                <div style="margin-top: 20px; background: #f8fafc; border-radius: 10px; padding: 16px; border: 1px solid #e2e8f0;">
                                    <p style="font-size: 13px; font-weight: 700; color: #1e293b; margin: 0 0 8px 0;">
                                        <i class="fa fa-info-circle" style="color: #00a896;"></i> Why is lab ownership proof required?
                                    </p>
                                    <p style="font-size: 12.5px; color: #64748b; margin: 0 0 10px 0; line-height: 1.5;">
                                        Please provide valid laboratory ownership documentation to verify your healthcare profile. This protects your diagnostic center credentials from unauthorized access.
                                    </p>

                                    <div style="font-weight: 700; font-size: 12.5px; color: #334155; margin-bottom: 6px;">Acceptable Verification Documents:</div>
                                    <ul class="acceptable-list">
                                        <li><i class="fa fa-check-circle"></i> Official Lab Prescription Pad</li>
                                        <li><i class="fa fa-check-circle"></i> Pathology Center Registration Certificate</li>
                                        <li><i class="fa fa-check-circle"></i> Municipal / Trade License Receipt</li>
                                        <li><i class="fa fa-check-circle"></i> Utility Bill (Electricity / Water) under Lab Name</li>
                                    </ul>
                                </div>
                                ...
                                <div style="display: flex; justify-content: space-between; align-items: center; margin-top: 24px; pt-3; border-top: 1px solid #e2e8f0; padding-top: 18px;">
                                    <a href="<?=base_url('pathlabpanel/updateprofile');?>" class="btn btn-default" style="background: #f1f5f9; border: 1px solid #cbd5e1; color: #475569; font-weight: 600; border-radius: 8px; padding: 9px 20px;">
                                    ...
                                    <button type="submit" name="submit" class="btn" style="background: #00a896; color: #ffffff; font-weight: 700; border-radius: 8px; padding: 9px 24px; box-shadow: 0 3px 10px rgba(0,168,150,0.25);">
                                        Save &amp; Continue <i class="fa fa-arrow-right" style="margin-left: 6px;"></i>
                                    </button>
                                </div>
                ...
                <!-- Right Document Preview & Trust Badge Column -->
                <div class="col-md-5">
                    <div class="preview-card-box">
                        <div style="font-size: 14px; font-weight: 700; color: #1e293b; margin-bottom: 12px; display: flex; align-items: center; justify-content: center; gap: 6px;">
                            <i class="fa fa-file-image-o" style="color: #00a896;"></i> Current Document Preview
                        </div>

                        <div class="preview-img-container" id="preview-container">
                            <?php if(!empty($src)): ?>
                                <img src="<?=base_url('admin1947/public/assets/upload/'.$src);?>" id="preview-image" alt="Uploaded Pathology Proof">
                            <?php else: ?>
                                <div id="no-preview-placeholder" style="padding: 40px 10px; color: #94a3b8;">
                                    <i class="fa fa-file-text-o" style="font-size: 42px; margin-bottom: 10px; color: #cbd5e1; display: block;"></i>
                                    <span style="font-size: 13px; font-weight: 600;">No Document Uploaded Yet</span>
                                    <p style="font-size: 11.5px; margin: 4px 0 0 0; color: #94a3b8;">Select a file to preview before saving.</p>
                                </div>
                                <img src="" id="preview-image" alt="Proof Preview" style="display: none;">
                            <?php endif; ?>
                        </div>
                        ...
                        <div style="margin-top: 20px; background: #eff6ff; border-radius: 10px; padding: 16px; border: 1px solid #bfdbfe; text-align: left;">
                            <div style="font-size: 13px; font-weight: 700; color: #1e3a8a; margin-bottom: 4px;">
                                <i class="fa fa-users" style="color: #2563eb;"></i> Reach Thousands of Patients
                            </div>
                            <p style="font-size: 12px; color: #3b82f6; margin: 0; line-height: 1.4;">
                                Thousands of patients search for verified pathology laboratories on Upchar Healthcare every day. Complete your verification to unlock diagnostic test bookings.
                            </p>
                        </div>
                    </div>
                </div>
        ...
        if (file.type.startsWith('image/')) {
            ...
            if (placeholder) {
                placeholder.innerHTML = '<i class="fa fa-file-pdf-o" style="font-size: 48px; color: #ef4444; margin-bottom: 10px; display: block;"></i>' +
                    '<span style="font-size: 13px; font-weight: 700; color: #1e293b;">PDF Document Selected</span><br>' +
