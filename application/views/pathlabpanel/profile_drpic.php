            ...
            <div style="display: flex; justify-content: space-between; align-items: center; flex-wrap: wrap; gap: 12px; margin-bottom: 20px;">
                <div>
                    <h2 style="font-size: 22px; font-weight: 700; color: #1e293b; margin: 0 0 4px 0;">
                        <i class="fa fa-picture-o" style="color: #00a896;"></i> Pathology Center Display Picture / Logo
                    </h2>
                    <p style="color: #64748b; font-size: 13px; margin: 0;">Upload your laboratory logo or official building photo for public listing.</p>
                </div>
                <div>
                    <a href="<?=base_url('pathlabpanel/profile_clinicproof');?>" class="btn btn-default" style="background: #ffffff; border: 1px solid #cbd5e1; color: #334155; font-weight: 600; border-radius: 8px; padding: 8px 18px;">
                    ...
                    <div class="pathlab-card">
                        <div class="pathlab-card-header">
                            <h3 class="pathlab-card-title">
                                <i class="fa fa-cloud-upload"></i> Upload Profile Image / Logo
                            </h3>
                            <span style="font-size: 12px; background: rgba(255,255,255,0.2); padding: 4px 10px; border-radius: 20px;">Step 3 of 4</span>
                        </div>
                        <div class="pathlab-card-body">
                            <form action="<?=base_url('pathlabpanel/profile_drpic');?>" method="post" enctype="multipart/form-data">
                                
                                <label class="path-form-label" style="font-size: 14px; font-weight: 700; color: #1e293b; margin-bottom: 10px; display: block;">
                                    Select Profile Photo / Logo Image <span style="color: #ef4444;">*</span>
                                </label>

                                <!-- Drag & Drop File Upload Box -->
                                <div class="file-upload-dropzone" id="dropzone-box">
                                    <input type="file" name="images" id="drpic_input" class="file-upload-input" accept="image/*" <?=(empty($src) ? 'required' : '');?> onchange="handleFilePreview(this)">
                                    ...
                                    <p style="font-size: 12.5px; color: #64748b; margin: 0;">
                                        Supported formats: JPG, PNG, JPEG (Max size: 5 MB)
                                    </p>
                                ...
                                <div style="margin-top: 20px; background: #f8fafc; border-radius: 10px; padding: 16px; border: 1px solid #e2e8f0;">
                                    <p style="font-size: 13px; font-weight: 700; color: #1e293b; margin: 0 0 4px 0;">
                                        <i class="fa fa-lightbulb-o" style="color: #00a896;"></i> Photo Recommendations
                                    </p>
                                    <p style="font-size: 12.5px; color: #64748b; margin: 0; line-height: 1.5;">
                                        Upload a clear high-resolution logo or front view photo of your diagnostic laboratory. High quality photos increase patient trust and booking conversions.
                                    </p>
                                </div>
                                ...
                                <div style="display: flex; justify-content: space-between; align-items: center; margin-top: 24px; pt-3; border-top: 1px solid #e2e8f0; padding-top: 18px;">
                                    <a href="<?=base_url('pathlabpanel/profile_clinicproof');?>" class="btn btn-default" style="background: #f1f5f9; border: 1px solid #cbd5e1; color: #475569; font-weight: 600; border-radius: 8px; padding: 9px 20px;">
                                        <i class="fa fa-arrow-left"></i> Previous Step
                                    </a>
                ...
                <div class="col-md-5">
                    <div class="preview-card-box">
                        <div style="font-size: 14px; font-weight: 700; color: #1e293b; margin-bottom: 12px; display: flex; align-items: center; justify-content: center; gap: 6px;">
                            <i class="fa fa-image" style="color: #00a896;"></i> Current Logo / Display Picture
                        </div>

                        <div class="preview-img-container" id="preview-container">
                            <?php if(!empty($src)): ?>
                                <img src="<?=base_url('admin1947/public/assets/upload/'.$src);?>" id="preview-image" alt="Lab Display Picture">
                            <?php else: ?>
                                <div id="no-preview-placeholder" style="padding: 40px 10px; color: #94a3b8;">
                                    <i class="fa fa-picture-o" style="font-size: 42px; margin-bottom: 10px; color: #cbd5e1; display: block;"></i>
                                    <span style="font-size: 13px; font-weight: 600;">No Image Uploaded Yet</span>
                                    <p style="font-size: 11.5px; margin: 4px 0 0 0; color: #94a3b8;">Select a photo to preview before saving.</p>
                                </div>
                                <img src="" id="preview-image" alt="Profile Preview" style="display: none;">
                            <?php endif; ?>
                        </div>
                        ...
                        <?php if(!empty($src)): ?>
                            <div style="margin-top: 12px; display: inline-flex; align-items: center; gap: 6px; background: #d1fae5; color: #065f46; font-size: 12px; font-weight: 700; padding: 5px 12px; border-radius: 20px;">
                                <i class="fa fa-check-circle"></i> Logo Active
                            </div>
                        <?php endif; ?>
                    </div>
                </div>
