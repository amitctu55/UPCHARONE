...
.remove_project_file img {
    ...
    <div class="onboarding-label u-spacer-lg--top">Hospital hours</div>
 ...
 <button type='button' class="continue3 addmore_sessions"  data-dayblock-id='<?=$key;?>'>Add More Sessions </button>
 ...
 <button type='button' class="continue3 addmore_sessions" data-dayblock-id='0'>Add More Sessions </button>
...
Correct operating hours will help patients in booking appointments only during your availability</span>
								...
								<div class="col-sm-12 padd0">                                        
                                  ...
                                  <div class="col-sm-8 click_step2  padding0">
                                        <a class="backiocn" href="<?=base_url();?>hospitalpanel/profile_maplocation"><i class="fa fa-long-arrow-left" aria-hidden="true"></i>Back</a>
                                    </div>
