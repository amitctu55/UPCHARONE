				...
				<div class="pag_cstm_panel_panel_ontent p-t-0">
                    <div class="row paddb40">
						<div class="col-sm-12 processsstep2">
							<a href='<?=base_url();?>hospitalpanel/addpackage'><button type='submit' name='submit' style="letter-spacing: 1px;text-shadow: 3px -1px 2px #666;font-weight:900;color:white;background:#1fc61f;padding:9px 23px;border-radius: 23px;float: right;border:none;">Add Package</button></a>
							<h4>Manage Package</h4>
						</div>
						<div class="row paddb40">
                            <div class="col-sm-12 processsstep2">
								<?php echo form_open("hospitalpanel/package/",'class="form-horizontal formbody" id="search_form" method="get"');  ?>
									<div class="col-md-3">
										<input style="border-radius: 23px;padding:0px 23px;" name='keyword' placeholder="Package Name, Amount" value="<?php echo $this->input->get_post('keyword')?>" >
									</div>
									<div class="col-md-3">
									...
									<div class="col-sm-1 col-xs-12">
										...
										{ 
											echo anchor("hospitalpanel/package/",'<span>Clear Search</span>'); 	  
										} 
										?>
									</div>
								<?php echo form_close();?>
								<div class="col-sm-12 processsstep2">
									<div class="table-responsive">
										...
										echo form_open_multipart("hospitalpanel/package/", $att);?> 
										<table id="datatable" class="table table-bordered" style="width:100%">
											...
											<tbody style="color:white;">
												...
												?>
												<td>
													<input style="width:15px;" type="checkbox" name="arr_ids[]" value="<?php echo $val['package_id'];?>" id="check-all" class="flat">
												</td>
												<?php echo"<td>".$val['title']."</td>";
												echo"<td>";?><?php echo $val['amount'];?> ₹.<?php echo "</td>";
												echo"<td>".$val['description']."</td>"; 
												echo "<td>";?>
												<?php $product_path = "/admin1947/public/assets/upload/".$val['image'];
												if($val['image']!=''){ ?>
												<a data-toggle="modal" style="color:red;" data-target="#myModal1<?php echo $val['package_id'];?>">View</a>
												<!-- The Modal -->
												<div class="modal" id="myModal1<?php echo $val['package_id'];?>">
													<div class="modal-dialog">
														<div class="modal-content">
															<!-- Modal Header -->
															<div class="modal-header">
																<button type="button" class="close" data-dismiss="modal">×</button>
																<h4 style="color:#535456;" class="modal-title">Image</h4>
															</div>
															<!-- Modal body -->
												...
												echo"<td>";?>
												<a style="color:red;" href="<?php echo base_url();?>hospitalpanel/editpackage/<?php echo $val['package_id'];?>">Update</a></td>
												<?php echo"</tr>";
												}
												}else{
												?>
