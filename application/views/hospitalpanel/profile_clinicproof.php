...
<div class="page-content" style="padding-top: 0;">
    <div class="profile-setup-wrap">
        ...
        <div class="profile-hdr-card">
            <div>
                <h1><i class="fa fa-file-text-o" style="color: #00a896; margin-right: 8px;"></i> Hospital Registration &amp; Proof Verification</h1>
                <p>Upload official hospital establishment proof, clinical license, or tax receipts to verify facility authenticity.</p>
            </div>
            <div>
                <a href="<?=base_url('hospitalpanel/updateprofile');?>" class="btn-back-link">
        ...
        <div class="profile-nav-tabs">
            ...
            <a href="<?=base_url('hospitalpanel/profile_clinicproof');?>" class="profile-nav-tab active">
        ...
        <div class="setup-grid">
            ...
            <div class="setup-card">
                <div class="setup-card-hdr">
                    <h3><i class="fa fa-upload"></i> Upload Ownership / Registration Proof</h3>
                </div>

                <div class="setup-card-body">
                    <?php echo form_open_multipart("hospitalpanel/profile_clinicproof", 'id="proofForm"');?>
                        <input type="hidden" name="<?=$this->security->get_csrf_token_name();?>" value="<?=$this->security->get_csrf_hash();?>">
                        
                        <div class="doc-upload-box">
                            <i class="fa fa-cloud-upload"></i>
                            <div style="font-weight: 700; font-size: 14px; color: #0f172a; margin-bottom: 4px;">
                                Select Hospital Registration Document
                            </div>
                            <p style="font-size: 12px; color: #64748b; margin-bottom: 16px;">
                                Supported Formats: JPG, PNG, JPEG (Max Size: 5MB)
                            </p>
                            
                            <input type="file" name="images" id="proofInput" class="form-control" accept="image/*" style="max-width: 340px; margin: 0 auto;" <?=(empty($src) ? 'required' : '');?>>
                        </div>
            ...
            <!-- Right: Document Guidelines & Existing Preview -->
            <div class="guidelines-card">
                <h4 style="font-size: 15px; font-weight: 800; color: #043d5b; margin: 0 0 14px 0;">
                    <i class="fa fa-check-square-o" style="color: #00a896;"></i> Acceptable Documents
                </h4>

                <ul style="padding-left: 20px; font-size: 13px; color: #475569; line-height: 1.6; margin-bottom: 20px;">
                    <li>Clinical Establishment Act Registration Certificate</li>
                    <li>Hospital / Nursing Home Trade License</li>
                    <li>Municipal Corporation Tax Receipt / Utility Bill</li>
                    <li>Official Hospital Letterhead / Prescription Pad</li>
                </ul>

                <?php if(!empty($src)): ?>
                    <div class="preview-box">
                        <strong style="font-size: 12px; color: #043d5b; display: block; margin-bottom: 8px;">
                            <i class="fa fa-check-circle" style="color: #10b981;"></i> Current Uploaded Document
                        </strong>
                        <a href="<?=base_url('admin1947/public/assets/upload/'.$src);?>" target="_blank">
                            <img src="<?=base_url('admin1947/public/assets/upload/'.$src);?>" alt="Hospital Proof Preview">
                        </a>
