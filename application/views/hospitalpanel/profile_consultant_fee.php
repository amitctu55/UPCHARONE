...
<style>
.add_tims_day {border-bottom: 1px solid #d6d6d6;margin-top: 19px;cursor: pointer;padding-bottom: 15px;
      font-weight: bold; }
  
.mrgt25 {  margin-top: 25px; }
  
.remove_project_file img {  width: 15px; margin-top: 14px; }
			            ...
			            <form action='' method='post' enctype="multipart/form-data">
							...
							<div class="u-spacer-lg--top">  
                                                ...
                                                <div id="add_div"  class='add_div'>
                                                    <div class="col-sm-12 clinic_days padding0">
                                                        <div>
                                                            ...
                                                            <div class="onboarding-label">Days: [<a href='<?=base_url()?>hospitalpanel/deletetiming/<?=base64_encode($timing->id);?>'>DELETE</a>]
                                                            </div>
                                                        <div>
                                        ...
                                        <div class="col-sm-12 padding0 sessions_wrapper" id="sessions_wrapper">
                                            ...
                                            <div class="u-spacer-lg--top" id="session_box">
                                                ...
                                                <div class="pure-g">
                                                    ...
                                                    <div class="pure-u-1-2">
                                                        <div class="Select e-timings--item e-timings--item-end Select--single has-value">
                                                            <input type="text" name="consultation_fee[<?=$key;?>][]" placeholder='Consultation Fees' class='text-center' value="<?=$session->consultation_fee;?>">
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="u-spacer-lg--top" id="session_box">
                                                ...
                                                <div class="pure-g">
													...
													<div class="pure-u-1-2">
													 ...
													 <div class="pure-u-1-2">
                                                        <div class="Select e-timings--item e-timings--item-end Select--single has-value">
                                                            <input type="text" name="consultation_fee[0][]" placeholder='Consultation Fees' class='text-center' value="">
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                ...
                                <div class="col-sm-12 hoslist_he mrtop">
                                    <span>
                                    Correct operating hours will help patients in booking appointments only during your availability
                                    </span>
...
$(document).ready(function() 
{
    ...
    {
	   var dblockid = $(this).attr('data-dayblock-id');
	   $(this).parent().find('.sessions_wrapper').append("<div class='u-spacer-lg--top' id='session_box2'> <div class='onboarding-label' data-qa-id='session1'>Sessions</div><div class='pure-g'> <div class='pure-u-1-2'>  <select class='form-control fixhei'  name='fromtime["+dblockid+"][]' ><option value=''> From</option><?=$timeoption;?></select> </div><div class='pure-u-1-2'> <div class='Select e-timings--item e-timings--item-end Select--single has-value'> <input type='hidden' name='session-timings-end' value='00:30'>  <select class='form-control fixhei'  name='totime["+dblockid+"][]' ><option value=''> To</option>   <?=$timeoption;?></select> </div></div>      <div class='pure-u-1-2'><div class='Select e-timings--item e-timings--item-end Select--single has-value'><input type='text' name='max_patient["+dblockid+"][]' placeholder='Max Patient' value='5' class='text-center'></div></div>       	<div class='pure-u-1-2'><div class='Select e-timings--item e-timings--item-end Select--single has-value'><input type='text' name='consultation_fee["+dblockid+"][]' placeholder='Consultation Fee' value='0' class='text-center'></div></div>			</div><a href='#' class='remove_project_file' border='2'><img src='assets/images/delete.png' /></a> </div>");
    });
