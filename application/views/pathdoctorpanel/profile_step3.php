                    ...
                    <div class="pag_cstm_panel" style="background: #295771;">
                        <div class="pag_cstm_panel_panel_ontent p-t-0">
                            <div class="row paddb40">
                                ...
                                <div class="col-sm-12 processsstep2">
                                    <h4 style="background:;color: white;padding: 9px;">Education Qualification</h4>
                                </div>
						...
						<?php } ?>
                                    ...
                                    <div class="col-sm-12 padding0">
                                        ...
                                        <input type="number" name="exp" value='<?=$data->exp;?>'  class="form-control" placeholder="Type Year of experience" required>
                                    </div>

                                    <div class="col-sm-8 click_step2 mrt30 padding0">
                                        <a class="backiocn" href="<?=base_url();?>profile_step12"><i class="fa fa-long-arrow-left" aria-hidden="true"></i>Back</a>
                                    </div>
                                ...
                                <div class="col-sm-5 hoslist_he mrgt30">
                                    ...
                                    <p style="word-spacing: 16px;color: #ffffff;background: #204356;padding: 20px;border-radius: 2px 21px;">
