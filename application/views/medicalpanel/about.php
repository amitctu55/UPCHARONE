...
">About Yourself</h4>
                                    <p style="background: #ed3237;color: white;padding: 5px 22px;width: 321px;box-shadow: 0px -2px 5px 0px #8a8282;text-transform: capitalize;text-shadow: 0px -2px 6px #a96363;font-weight: bold;font-size: 21px;"><?=$this->session->userdata('medicalusername');?></p>
                                </div>
...
<p>Please write something about yourself, It will be visible to all the user of the website and application under your profile .<br/></p>
                                  ...
                                  <div class="col-sm-8 click_step2 mrt30 padding0">
                                        <a class="backiocn" href="<?=base_url();?>profile_step23"><i class="fa fa-long-arrow-left" aria-hidden="true"></i>Back</a>
                                    </div>
