...
<?php $this->load->view("includes/header.php"); ?>
    ...
    <div class="careplus-subheader">
                        ...
                        <div class="col-sm-4 col-md-offset-4 borders" id="designforform">
                          <div class="box-header"><h4>OTP Number</h4></div>
                            <div class="label_name">                 
                                <p></p>
                                   <span>Enter OTP Number 6 Digit</span><form id='drsignupotpform' action='<?=base_url();?>Medicaluser/verifysignupotp' method='post'>
      ...
      <button type="submit" class="btn  btn-lg common-btn practo-btn" style="margin-top: 10px!important;border:none;color: white;background: #ed3237;"> Send Query </button></form>
                    ...
                    <div class='pull-right '> <a href='#' class='pull-right drresendotp' style="background: #295771;font-weight: bold;color: white;padding: 10px;">Resend OTP</a></div>       
	...
	$('.drresendotp').click(function(e) {		
		...
		$.ajax({			
		type: "POST",			
		url: '<?=base_url();?>Medicaluser/resendsignupotp',//myform.attr('action'),			
		//data: myform.serialize(),			
		success: function( response ) {				
			response = JSON.parse(response);				
			if(response.status=='success'){										
