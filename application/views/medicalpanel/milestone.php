              ...
              <div class="pag_cstm_panel" style="background: white;">
                <div class="pag_cstm_panel_panel_ontent p-t-0">
                  <div class="row paddb40">
								...
								<p class="process">Medical basic details, medical registration, education qualification, clinic details etc.</p>
				<a href="<?=base_url().'profile_step21'?>"><button class="continue">Continue</button></a>

							<div class="step2 border1">
							<p class="step2" style="background:#043d5b;">Section B: Profile verification</p>	
						<p class="process2">Medical identity proof, registration proof, clinic ownership proof etc.</p>
