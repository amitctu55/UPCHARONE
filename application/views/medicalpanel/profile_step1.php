          ...
          <div class="row">
		   <div class="col-lg-12">
            ...
            <form action='' method='POST'>
								...
								<h4>Hi <span style="margin-left: 16px;border-radius: 0px 12px;padding: 2px 9px;background: #ed3237;" id="drname"><?=$this->session->userdata('medicalusername');?> </span> <br><br>Lets build your dedicated profile.</h4>
								
								<p class="step1">Section A: Profile details</p>
								<div class="col-sm-12 padding0">                    
                                   <label style="color:black;">Medical Name</label>
