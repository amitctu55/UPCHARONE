...
<!--
 ...
 <h3 class="formHeading">SIGN UP FOR MEDICAL</h3>
    
<ul class="dis_inli1">
    <li class="cwhi1"><a href="<?=base_url('medical-login');?>">Login</a></li>
    <li ><a class="actives" href="<?=base_url('medical-signup');?>">Sign up</a></li>
...
<div class="col-sm-12 borders"><form id='drregistrationform' action='<?=base_url();?>Medicaluser/register' method='post'>
