          ...
          <div class="row">
		   <div class="col-lg-12">
              <div class="pag_cstm_panel">
				...
				<a href="<?=base_url();?>profile_step1"><i class="fa fa-check-square-o" aria-hidden="true"></i>
Change Profile</a>
						...
						<p class="process2">Doctor identity proof, registration proof, clinic ownership proof etc.</p>
								<a href="<?=base_url();?>profile_idproof"><i class="fa fa-check-square-o" aria-hidden="true"></i>	Change Profile</a>
						</div>
						<div class="step2 border1">
							<p class="step2">Step C: Start getting patients</p>	
						<p class="process2">Location, Timings, Fees</p>
						<a href="<?=base_url();?>profile_maplocation"><button class="continue">Continue</button></a>
