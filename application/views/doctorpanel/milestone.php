          ...
          <div class="row">
		   <div class="col-lg-12">
              <div class="pag_cstm_panel" style="background: white;">
				...
				<a href="<?=base_url().'profile_step1'?>">
				    
				    	<div class="border1">
							<p class="step1">Section B: Profile verification</p>	
						...
						<div class="border1">
							<p class="step1">Step C: Start getting patients</p>	
				    ...
				    <button class="continue">Continue</button></a>
