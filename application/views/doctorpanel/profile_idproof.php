                    ...
                    <div class="pag_cstm_panel" style="background: #295771;color:white;">
                        <div class="pag_cstm_panel_panel_ontent p-t-0">
                            <div class="row paddb40">
                                	<h4 class="PageTitle">Identity Proof</h4>
...
<li><i class="fa fa-check" aria-hidden="true"></i> Aadhar Card</li>
<li><i class="fa fa-check" aria-hidden="true"></i> Driving License	</li>
<li><i class="fa fa-check" aria-hidden="true"></i> Voter Card</li>
<li><i class="fa fa-check" aria-hidden="true"></i> Any other Govt. ID</li>
</ul>
