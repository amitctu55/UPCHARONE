                ...
                <div class="col-lg-12">
                    <div class="pag_cstm_panel">
                        <div class="pag_cstm_panel_panel_ontent p-t-0">
							...
							<h4>Manage Doctors 
							<a href='<?=base_url();?>doctorpanel/adddoctor'><button type='submit' name='submit' class="btn btn-primary pull-right">Add Doctor</button></a></h4>
					 ...
					 <table id="datatable" class="display" style="width:100%">
								...
								<tr><td> <?=$p->fname.' '.$p->lname;?></td>
										...
										<a href='<?=base_url()?>hospitalpanel/updatedoctor/<?=mybase64_encode($p->id);?>'><?php if($p->status==1)
                                       {
                                       	echo"Update Timing & Fee";
                                       }
                                      
                                       	elseif($p->status==0)
                                       {
                                       	echo"<a href=#>Update Timing & Fee</a>";
                                       }
										?></a></a>
