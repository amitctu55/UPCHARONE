    ...
    <div class="container">
        <div class="hero-search-header">
            <div class="hero-trust-pill">
                <i class="fas fa-shield-alt"></i> India's Trusted Healthcare & Doctor Network
            </div>
...
<section class="section-wrapper" style="background: #FFFFFF; padding: 60px 0;">
    <div class="container">
        ...
        <div class="specialization-category-grid">
            <!-- Specialization 1: General Medicine -->
...
<!-- 8. LATEST HEALTH NEWS & ARTICLES -->
<?php if (!empty($news)) { ?>
<section class="section-wrapper" style="background: #FFFFFF; padding: 60px 0;">
    <div class="container">
        <div class="section-title-wrap">
            <span class="section-badge">Health Articles</span>
            <h2 class="section-main-heading">Latest Health Tips & Medical News</h2>
            <p class="section-sub-heading">Stay informed with curated wellness guides, medical updates, and preventive health advice.</p>
        </div>
        <div class="row">
            <?php foreach($news as $n){ 
                $nImg = ($n->image && file_exists('admin1947/public/assets/upload/'.$n->image))
                        ? admin_url().'public/assets/upload/'.$n->image
                        : admin_url().'public/assets/upload/dummy_video.jpg';
            ?>
            <div class="col-md-3 col-sm-6" style="margin-bottom: 24px;">
                <div class="modern-news-card">
                    <img loading="lazy" src="<?=$nImg;?>" alt="<?=$n->title;?>" class="modern-news-thumb">
                    <div class="modern-news-body">
                        <h4 class="modern-news-title">
                            <a href="<?=base_url();?>news/<?=mybase64_encode($n->id);?>"><?=substr(strip_tags($n->title), 0, 45);?><?=(strlen(strip_tags($n->title)) > 45 ? '...' : '');?></a>
                        </h4>
                        <p class="modern-news-desc"><?=substr(strip_tags($n->description), 0, 85);?><?=(strlen(strip_tags($n->description)) > 85 ? '...' : '');?></p>
...
<!-- 9. OUR HEALTHCARE PARTNER PORTALS -->
<section class="section-wrapper" style="padding: 60px 0; background: #F8FAFC;">
    <div class="container">
        <div class="section-title-wrap">
            <span class="section-badge">Partnership</span>
            <h2 class="section-main-heading">Join Our Healthcare Network</h2>
            <p class="section-sub-heading">Partner with Upchar to grow your medical practice, clinic, hospital, lab, or pharmacy.</p>
        </div>
        <div class="row">
            <div class="col-md-3 col-sm-6">
                <div class="modern-partner-card">
                    <div class="modern-partner-icon"><i class="fas fa-hospital"></i></div>
                    <h5>Hospitals & Clinics</h5>
                    <p>Verified institutions offering comprehensive inpatient & outpatient care.</p>
                    <a href="<?=base_url('hospital-login');?>" class="modern-partner-btn">Hospital Portal</a>
                </div>
            </div>
            <div class="col-md-3 col-sm-6">
                <div class="modern-partner-card">
                    <div class="modern-partner-icon"><i class="fas fa-user-md"></i></div>
                    <h5>Specialist Doctors</h5>
                    <p>Experienced consultants and surgeons across all major medical fields.</p>
                    <a href="<?=base_url('doctor-login');?>" class="modern-partner-btn">Doctor Portal</a>
                </div>
            </div>
            <div class="col-md-3 col-sm-6">
                <div class="modern-partner-card">
                    <div class="modern-partner-icon"><i class="fas fa-flask"></i></div>
                    <h5>Pathology Labs</h5>
                    <p>Accredited diagnostic centers providing rapid and accurate lab reports.</p>
                    <a href="<?=base_url('pathlab-login');?>" class="modern-partner-btn">Lab Portal</a>
                </div>
            </div>
            <div class="col-md-3 col-sm-6">
                <div class="modern-partner-card">
                    <div class="modern-partner-icon"><i class="fas fa-pills"></i></div>
                    <h5>Pharmacy Services</h5>
                    <p>Fast and reliable doorstep delivery of genuine prescription medicines.</p>
