...
{	
	...
	{		
		...
		$this->db->select('SQL_CALC_FOUND_ROWS appointment.appointment_id, appointment.appointment_date, appointment.from_timing, appointment.to_timing, appointment.appointment_name as patient_name, appointment.appointment_mobile, appointment.fee, appointment.amount, appointment.doctor_id, appointment.institute_id, appointment.institution_type, appointment.status, appointment.payment_status, appointment.appointment_status, appointment.cancel_reason, appointment.cancel_date, appointment.cancel_by, appointment.ref_no, appointment.payment_mode, profile_dr.fname, profile_dr.lname, profile_dr.drimage', FALSE);
